...
def danbooru_search(tags="") -> str:
    ...
    neutral = {
        ...
        'pov': ["sideways","wide shot","from behind","cowboy shot","portrait","very wide shot","upper body","vanishing point","lower body","dutch angle","panorama","full body","close-up","atmospheric perspective","pov","upside-down","from above","fisheye","face","perspective","cut-in","rotated"],
        ...
        'misc': ["foodgasm","portrait","profile"],
    }
    male = {
